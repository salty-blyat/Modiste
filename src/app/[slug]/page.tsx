...
const ProductDetails = ({ params }: { params: string }) => {
    ...
    // const [selectedSize, setSelectedSize] = useState<string | null>(null); // Initialize selected size state
    ...
    const totalInCart = cartItems
        ...
        .reduce((acc, item) => acc + item.inCart, 0); // Sum the inCart values of the filtered items
